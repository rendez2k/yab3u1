...
PUBLIC_FILES = (
    ...
    "downloads/makerworld-yab3d-review-1.5.3.6.zip",
    ...
    "shared/fdmMix.js",
    "shared/blendCalibration.js",
    "shared/calibrationPanel.js",
    "shared/calibrationSwatches.js",
    "shared/surfaceWeights.js",
    "shared/layout.js",
    "shared/mix.js",
    "shared/mix_model.js",
    "shared/paint.js",
...
class SiteBuild(unittest.TestCase):
    ...
    def test_extension_download_is_installable_and_includes_licences(self):
        package = pathlib.Path(HERE, "web/downloads/makerworld-yab3d-review-1.5.3.6.zip")
        with zipfile.ZipFile(package) as archive:
            ...
            self.assertEqual(manifest["version"], "1.5.3.6")
